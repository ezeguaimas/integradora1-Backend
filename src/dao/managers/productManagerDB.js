...
export async function uploadProducts(req, res) {
  try {
    ...
    console.error(error);
    res.status(500).send({ error: "Error al agregar los productos" });
  }
};


export default {addProduct, getProducts, getProductById, updateProduct, deleteProduct, uploadProducts}